...
一集的 BGM 必须多于一首（用户硬要求）：每集至少 2 段、至少 2 首，按正文情绪分段选曲，切点落在镜头包边界上。逐段记录选曲与时间、来源、理由、音量与过渡、试听结果；跨集重复仅提示复核，不得据此把一集压缩成一首。执行 `tweet-drama-background-render` 的音频与过渡规则；曲目及选曲渠道须满足发行用途的许可证要求。
