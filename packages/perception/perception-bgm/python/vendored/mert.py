...
class FeatureExtractorMERT:
    def __init__(self, model_name="m-a-p/MERT-v1-95M", device = "None", sr=24000):
        ...
        self.model = AutoModel.from_pretrained(self.model_name, trust_remote_code=True, revision='12af15fef9d0ac838c3f475bfbbf26d2060dd4f5').to(self.device)
        self.processor = Wav2Vec2FeatureExtractor.from_pretrained(self.model_name, trust_remote_code=True, revision='12af15fef9d0ac838c3f475bfbbf26d2060dd4f5')
