...
Source: [`packages/guard/composition-guard/src/index.ts:54`](../packages/guard/composition-guard/src/index.ts)
...
Source: [`packages/guard/drama-gate/src/index.ts:46`](../packages/guard/drama-gate/src/index.ts)
...
Source: [`packages/drama/tool-episode-render/src/index.ts:63`](../packages/drama/tool-episode-render/src/index.ts)
...
Source: [`packages/jubian/tool-jubian/src/index.ts:30`](../packages/jubian/tool-jubian/src/index.ts)
