...
const OVERRIDES: Record<string, { license?: string; repo?: string }> = {
  ...
  // The published manifest carries neither `repository` nor `homepage`; the
  // npm page is the reachable record for the channel SDK that re-exports the
  // platform's `registerApp` helper.
